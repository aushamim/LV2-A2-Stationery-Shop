declare module "shurjopay" {
  ...
  class Shurjopay {
    ...
    config(root_url: string, merchant_username: string, merchant_password: string, merchant_key_prefix: string, return_url: string): void;
    ...
    makePayment(checkout_params: PaymentRequest, checkout_callback?: Callback<PaymentResponse>, error_handler?: ErrorHandler): void;

    verifyPayment(order_id: string, callback: Callback<VerificationResponse[]>, error_handler: ErrorHandler): void;

    paymentStatus(order_id: string, callback: Callback<VerificationResponse>, error_handler: ErrorHandler): void;
